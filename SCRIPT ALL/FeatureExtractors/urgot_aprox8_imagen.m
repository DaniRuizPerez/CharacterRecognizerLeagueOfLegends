function X = urgot_aprox8_imagen(image)
      ...
      carac1 = image(round(2*sizey/5):(sizey-round(4*sizey/9)), (round(sizex)-round(2*sizex/9)):sizex, 1:3);
      carac2 = image(round(2*sizey/5):sizey - round(2*sizey/5), round(sizex/3):sizex - round(sizex/3), 1:3);
